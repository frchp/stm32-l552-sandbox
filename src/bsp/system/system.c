...
void system_PRV_InitGpio(void)
{
  ...
  GPIO_InitStruct.Pin = BOARD_ADC_MTR_CURRENT_PIN;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(BOARD_ADC_MTR_CURRENT_PORT, &GPIO_InitStruct);

  /** TIM2_CH1 GPIO Configuration for BOARD_GPIO_MTR_FB */
  LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
  GPIO_InitStruct.Pin = BOARD_GPIO_MTR_FB_PIN;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  LL_GPIO_Init(BOARD_GPIO_MTR_FB_PORT, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = BOARD_GPIO_MTR_CTRL_PIN;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  LL_GPIO_Init(BOARD_GPIO_MTR_CTRL_PORT, &GPIO_InitStruct);
  LL_GPIO_SetAFPin_0_7(BOARD_GPIO_MTR_CTRL_PORT, BOARD_GPIO_MTR_CTRL_PIN, LL_GPIO_AF_1);

  /* Direction GPIO */
  GPIO_InitStruct.Pin = BOARD_GPIO_MTR_DIR_PIN;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  LL_GPIO_Init(BOARD_GPIO_MTR_DIR_PORT, &GPIO_InitStruct);
}
